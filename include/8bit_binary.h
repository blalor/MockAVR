/*
I know "real programmers" don't need to cheat like this, but when verifying
bit patterns, it's easier (for me) to see them without having to do the math.

>>> for x in range(0,256):
...    print ('#define B%s 0x%02X' % (('%8s' % (bin(x)[2:],)).replace(' ', '0'),x))
*/
